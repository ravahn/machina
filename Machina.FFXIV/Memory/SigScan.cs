...
namespace Machina.FFXIV.Memory
{
    ...
    public class SigScan : ISigScan
    {
        protected virtual Dictionary<SignatureType, int[]> Signatures => new Dictionary<SignatureType, int[]>()
        {
            ...
            { SignatureType.OodleNetwork1UDP_Train, SignatureStringToByteArray("83 fd 01 75 ** 48 8b 0b e8 ** ** ** ** eb ** 48 8b ** ** e8") },
            { SignatureType.OodleNetwork1UDP_Decode, SignatureStringToByteArray("74 ** 49 8b ca e8 ** ** ** ** eb ** 48 8b 49 ** e8") },
            { SignatureType.OodleNetwork1UDP_State_Size, SignatureStringToByteArray("48 8b 44 24 ** 48 8b ** ** 4d 85 ed 75 ** 48 89 ** ** e8") },
            ...
            { SignatureType.OodleNetwork1TCP_State_Size, SignatureStringToByteArray("48 8b 44 24 ** 48 8b ** ** 4d 85 ed 75 ** 48 89 ** ** e8 ** ** ** ** 4c ** ** e8") },
            { SignatureType.OodleNetwork1TCP_Train, SignatureStringToByteArray("83 fd 01 75 ** 48 8b 0b e8") },
